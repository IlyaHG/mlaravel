    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <div class="row justify-content-between">
            <div class="subheader">
                <h1 class="subheader-title">
                    <i class='subheader-icon fal fa-users'></i> Список
                    <br>пользователей </br>
                </h1>
            </div>
            ...
            <div class="subheader">
                <h1 class="subheader-title">
                    <i class='subheader-icon fal fa-cloud'> @include('widgets.weatherWidget')</i>
                </h1>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="border-faded bg-faded p-3 mb-g d-flex mt-3">
                    <input type="text" id="js-filter-contacts" name="filter-contacts"
                           class="form-control shadow-inset-2 form-control-lg" placeholder="E-mail пользователя">
        ...
        <div class="row" id="js-contacts">
            ...
            @foreach($users as $user)
                ...
                <div class="col-xl-4">
                    <div id="{{$user->id}}" class="card border shadow-0 mb-g shadow-sm-hover"
                         data-filter-tags="{{$user->toArray()['data-filter-tag']  }}">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-{{$user->status}} mr-3">
                                    <span class="rounded-circle profile-image d-block "
                                          style="background-image:url('/storage/images/avatars/{{$user->avatar}}'); background-size: cover;"></span>
                                </span>
                                ...
                                <div class="info-card-text flex-1">
                                    ...
                                    @if((auth()->id() == $user->id) || auth()->user()->is_admin == 'true')
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="{{route('status',$user->id)}}">
                                                <i class="fa fa-sun"></i>
                                                Установить статус</a>
                                            <a class="dropdown-item" href="{{route('upload_avatar',$user->id)}}">
                                    ...
                                    @endif
                                    <span class="text-truncate text-truncate-xl">{{$user->role}}</span>
                                </div>
