                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="name" id="simpleinput" class="form-control" required placeholder="Ваше имя">
                                </div>

                                <!-- title -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Роль в команде</label>
                                    <input type="text" name="role" id="simpleinput" class="form-control" required placeholder="Ваша роль">
                                </div>

                                <!-- tel -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Номер телефона</label>
                                    <input type="text" name="phone" id="simpleinput" class="form-control" placeholder="Ваш номер телефона">
                                </div>

                                <!-- address -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Адрес</label>
                                    <input type="text" name="address" id="simpleinput" class="form-control" placeholder="Ваш адрес">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email" id="simpleinput" class="form-control" required placeholder="Ваш эл.адрес, будет использован как логин при входе">
                                </div>

                                <!-- password -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Пароль</label>
                                    <input type="password" name="password" id="simpleinput" class="form-control" required placeholder="Ваш пароль, не менее 8 символов">
                                </div>
